...
public class CalcForces extends Thread
{
	private Thread t;
	...
	public CalcForces(String t_name, Body[] bodies, int start, int end, double DT, Barrier barrier1, Barrier barrier2, int totalSteps)
	{
		this.t_name = t_name;
		this.bodies = bodies;
		this.start = start;
