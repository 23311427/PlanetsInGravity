...
public class Nbody2
{
	...
	public static void main(String[] args)
	{
		...
		CalcForces2[] calculators = new CalcForces2[numWorkers];
		Barrier2 barrier1 = new Barrier2(numWorkers);
		Barrier2 barrier2 = new Barrier2(numWorkers);
		...
		for (int i = 0; i < calculators.length; i++)
		{
			...
			if (i == calculators.length-1)
			{
				...
				calculators[i] = new CalcForces2("thread_" + i, allBodies, numBodies/numWorkers * i, numBodies, DT, barrier1, barrier2, timeSteps);
			}
			else 
			{
				calculators[i] = new CalcForces2("thread_" + i, allBodies, numBodies/numWorkers * i, numBodies/numWorkers * (i+1), DT, barrier1, barrier2, timeSteps); 
			}
		}
